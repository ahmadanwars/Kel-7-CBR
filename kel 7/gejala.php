...
echo "<h1>Hasil penghitungan similarity:</h1>";
foreach ($similarities as $disease => $similarity) {
    echo "<p>$disease: $similarity</p>";
}
...
foreach ($diseases as $disease) {
    echo "<p>Penyakit $disease adalah penyakit yang mungkin Anda alami dengan nilai similaritas $max_similarity.</p>";
}
?>
